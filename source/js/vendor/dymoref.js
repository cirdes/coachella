...
(function () {
    ...
    function Ka(a) {
        for (var b = 1; b < arguments.length; b++) {
            var c = arguments[b],
                d;
            if (u(c) || (d = v(c)) && c.hasOwnProperty("callee")) a.push.apply(a, c);
            else if (d)
    ...
    function Oa(a, b, c) {
        ...
        else if (v(a) || w(a)) Fa(a, b, c);
        else {
            var d;
            if (typeof a.G == "function") d = a.G();
            else if (typeof a.M != "function")
                if (v(a) || w(a)) {
                    d = [];
    ...
    function Xa(a, b) {
        try {
            ...
            c = typeof a == "string" ? {
                ...
                message: a.message,
                name: a.name,
                lineNumber: a.lineNumber || a.lc || "Not available",
                fileName: a.fileName || a.filename || a.sourceURL || d,
    ...
    function Za(a, b) {
        var c = [];
        if (Ea(b, a) >= 0) c.push("[...circular reference...]");
    ...
    function tb(a, b) {
        ...
        var c = a,
            ...
            f = !!d.v;
        if (f) db(e, d.v);
        else f = !!d.O; if (f) eb(e, d.O);
        else f = !!d.t; if (f) fb(e, d.t);
        else f = d.I != m;
        var g = d.q;
        if (f) gb(e, d.I);
        else if (f = !!d.q) {
    ...
    var Eb = xb,
        ...
        Gb = zb,
        Hb = q.navigator,
        Ib = (Hb && Hb.platform || "").indexOf("Mac") != -1,
        Jb;
    a: {
        var Kb = "",
            Lb;
    ...
    function Ub(a, b) {
        za(b, function (c, d) {
            ...
            else if (d in Vb) a.setAttribute(Vb[d], c);
            else a[d] = c
        })
    }
    var Vb = {
    ...
    function Wb() {
        ...
        if (c)
            if (w(c)) b.className = c;
            else u(c) ? wb.apply(m, [b].concat(c)) : Ub(b, c);
    ...
    function Yb(a) {
        if (a && typeof a.length == "number")
            ...
            else if (x(a)) return typeof a.item == "function";
        return n
    };
    ...
    gc.prototype.send = function (a, b, c, d) {
        ...
        c = this.ga.A();
        for (var g in a)
            if (!a.hasOwnProperty || a.hasOwnProperty(g)) rb(c, g, a[g]);
        if (b) {
    ...
    function kc(a, b, c) {
        ...
        if (q._callbacks_[a])
            if (c) delete q._callbacks_[a];
            else q._callbacks_[a] = ca
    };
    ...
    var oc = new nc("SEVERE", 1E3),
        pc = new nc("INFO", 800),
        qc = new nc("CONFIG", 700),
        L = new nc("FINE", 500),
        rc = new nc("FINER", 400),
        sc = new nc("FINEST", 300);
    ...
    K.prototype.log = function (a, b, c) {
        if (a.value >= tc(this).value) {
            ...
            for (b = this; b;) {
                ...
                var d = a;
                if (c.db)
                    for (var e = 0, f = void 0; f = c.db[e]; e++) f(d);
                b = b.oa
            }
        }
    };
    ...
    p.la = function (a, b, c, d, e, f) {
        if (x(a)) this.fb = l;
        else if (a && a.handleEvent && x(a.handleEvent)) this.fb = n;
        else i(Error("Invalid listener argument"));
        this.ca = a;
        this.ib = b;
        this.src = c;
        this.type = d;
    ...
    function Yc(a, b, c, d, e) {
        ...
        for (f = 0; f < a.length; f++)
            if (a[f].ca == c && a[f].capture == d && a[f].Ea == e) return Zc(a[f].key);
        return n
    }
    ...
    p.dispatchEvent = function (a) {
        ...
        if (d in e) {
            ...
            if (n in e) {
                ...
                f.s = f.c;
                if (d)
                    for (g = 0; !a.S && g < c.length && f.s; g++) {
                        a.currentTarget = c[g];
                        b &= bd(f, c[g], a.type, n, a) && a.pa != n
                    } else
                        for (c = this; !a.S && c &&
                            f.s; c = c.Ma) {
                            a.currentTarget = c;
                            b &= bd(f, c, a.type, n, a) && a.pa != n
                        }
            }
            a = Boolean(b)
        } else a = l;
    ...
    function fd(a, b, c) {
        if (x(a)) {
            if (c) a = ha(a, c)
        } else if (a && typeof a.handleEvent == "function") a = ha(a.handleEvent, a);
        else i(Error("Invalid listener argument"));
    ...
    var qd = {
        ...
        rd = /\uffff/.test("\uffff") ? /[\\\"\x00-\x1f\x7f-\uffff]/g : /[\\\"\x00-\x1f\x7f-\xff]/g;
    ...
    p.send = function (a, b, c, d) {
        ...
        if (Gb) d.marginTop = d.marginLeft = "-10px";
        else {
            d.position = "absolute";
            d.top = d.left = "-10px"
        } if (I) {
            ...
            if (Eb) a.documentElement.innerHTML = c;
            else a.write(c);
            ...
            for (b = f.length; c < b; c++) {
                ...
                if (h != f[c].value) {
                    g = f[c];
                    h = f[c].value;
                    if ("textContent" in g) g.textContent = h;
                    else if (g.firstChild && g.firstChild.nodeType == 3) {
    ...
    function Od(a) {
        for (var b = 0; b < navigator.plugins.length; ++b)
            for (var c = navigator.plugins[b], d = 0; d < c.length; ++d)
                if (c[d].type == a) return l;
        return n
    }
        ...
        if (!V) {
            ...
            if ("ActiveXObject" in window) {
                ...
                V.printLabel2 = function (e, f, g, h) {
                    if (x(b.PrintLabel2)) return b.PrintLabel2(e, f, g, h).toString();
                    b.PrintLabel(e, f, g, h)
                };
                V.getJobStatus = function (e, f) {
                    var g;
                    g = x(b.GetJobStatus) ? Nd(b.GetJobStatus(e, parseInt(f, 10))) : {
                        status: Q.ia,
                ...
                if (c) {
                    ...
                    V.loadImageAsPngBase64 =
                        function (e) {
                            return c.loadImageAsPngBase64(e)
                        };
                    V.printLabel2 = function (e, f, g, h) {
                        if (x(c.printLabel2)) return c.printLabel2(e, f, g, h).toString();
                        c.printLabel(e, f, g, h)
                    };
                    V.getJobStatus = function (e, f) {
                        var g;
                        g = x(c.getJobStatus) ? Nd(c.getJobStatus(e, parseInt(f, 10))) : {
                            status: Q.ia,
                            statusMessage: "not implemented"
                        };
                        return new Md(e, f, g.status, g.statusMessage)
                ...
                if (d = Od("application/x-dymolabel") ? Pd() : Td()) {
                    ...
                    V.getJobStatus = function (e,
                        f) {
                        var g;
                        g = x(d.getJobStatus) ? Nd(d.getJobStatus(e, parseInt(f, 10))) : {
                            status: Q.ia,
                            statusMessage: "not implemented"
                        };
                        return new Md(e, f, g.status, g.statusMessage)
    ...
    X.prototype.Mb = aa("ja");
    X.prototype.getJobId = X.prototype.Mb;
    X.prototype.Da = function (a) {
        if (this.W.l != "") Zd(this, a);
        else {
            var b;
            try {
                b = W().getJobStatus(this.W.name, this.ja)
            } catch (c) {
                b = new Md(this.Ca(), this.ja, Q.qa, c.message || c)
            }
            a(b)
        }
    };
    ...
    function Zd(a, b) {
        var c = a.Ca(),
            d = a.ja,
            e = a.W.l;
        (new gc(tb(e, "getPrintJobStatus"), "callback")).send({
            jobId: d,
            printerName: a.W.ea
        }, function (f) {
            b(new Md(c, d, f.status, f.statusMessage))
        }, function () {
            b(new Md(c, d, Q.qa, 'Error processing getPrintJobStatus(): Unable to contact "' + e + '"'))
        })
    };
    ...
    function ie(a, b, c) {
        ...
        for (h = 0; h < c.length; h++) {
            ...
            if (h < c.length - 1) r += "\n";
            g = t;
            if (b.length > 0) g = h < b.length ? b[h] : b[b.length - 1];
            else if (e.length > 0) g = h < e.length ? T(e[h], "Font") : T(e[e.length - 1], "Font");
            j = f;
    ...
    s("dymo.label.framework.VERSION", "1.2.6", void 0);
    ...
    function Vd() {
        ...
        if (b.indexOf("Win") != -1)
            if ("ActiveXObject" in window) {
                a.ma = l;
                try {
                    if (typeof new ActiveXObject("DYMOLabelFrameworkIEPlugin.Plugin") != "object") a.F = "Unable to create DYMO.Label.Framework ActiveX object. Check that DYMO.Label.Framework is installed";
                    else a.$ = l
                } catch (c) {
                ...
                if (Od("application/x-dymolabel")) a.$ =
                    l;
                else a.F = "DYMO Label Framework Plugin is not installed"
            } else if (b.indexOf("Mac") != -1) {
            a.ma = l;
            if (Od("application/x-dymolabel")) {
                b = Pd();
                if (b.GetAPIVersion() >= "2.0") a.$ = l;
                else a.F = "DYMO Label Safari Plugin is installed but outdated. Install the latest version."
    ...
    function ne(a) {
        ...
        for (var d = 0; d < b.length; d++) {
            var e = S(T(b[d], "Name")),
                f = S(T(b[d], "ModelName")),
                g = S(T(b[d], "IsConnected")) == "True",
                h = S(T(b[d], "IsLocal")) == "True",
                j = S(T(b[d], "IsTwinTurbo")) == "True";
            e = new Xd(e, f, g, h, j);
            a[d] = e;
            a[e.name] = e
        }
    ...
    function be(a, b, c, d) {
        ...
        var e = oe()[a];
        if (e != m) e.l != "" ? qe(e, b, c, d) : W().printLabel(e.name, b, c, d);
        else i(Error("printLabel(): unknown printer '" + a + "'"))
    }
    ...
    function ce(a, b, c, d) {
        ...
        if (typeof c != "string") c = c.toString();
        var e = oe()[a];
        if (e != m) return e.l != "" ? qe(e, b, c, d) : new X(e, W().printLabel2(a, b, c, d));
        else i(Error("printLabel(): unknown printer '" + a + "'"))
    }
    ...
    function qe(a, b, c, d) {
        function e(j, k) {
            ...
            (new gc(g, "c")).send({
                ...
                var B = t.status;
                if (B == 0) j != -1 ? e(++j, 0) : M("dymo.label.framework").info("Finished sending job payload for " + f);
                else if (B == -5) k < 10 ? e(++t.lastAckChunkId, ++k) : M("dymo.label.framework").error('Unable to send print job data for "' + f + '": STATUS_INVALID_CHUNK_ID: Max retry count reached');
                else k < 10 ? e(j, ++k) : M("dymo.label.framework").error('Unable to send print job data for "' +
    ...
    s("dymo.label.framework.renderLabelAsync", function (a, b, c, d) {
        ...
        if (d == m || e != m && e.l == "") {
            ...
            var j =
                Fd();
            wd(tb(e.l, "renderLabel"), m, "POST", l, {
                requestId: j,
                printerName: e.ea,
                labelXml: a,
                renderParamsXml: c
            ...
            k = new gd(function () {
                if ((new Date).getTime() - o > 3E4) {
                    ...
                    k = m;
                    b(re(j, "Timeout", "", ""))
                } else(new gc(tb(e.l, "getRenderLabelStatus"), "callback")).send({
                    requestId: j
                }, function (r) {
                    var t = r.statusId;
    ...
    s("dymo.label.framework.createLabelWriterPrintParamsXml", function (a) {
        if (!a) return "";
        var b = J("<LabelWriterPrintParams/>"),
            c = b.documentElement;
